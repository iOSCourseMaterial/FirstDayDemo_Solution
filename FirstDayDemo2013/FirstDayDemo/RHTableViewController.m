...
- (void)viewDidLoad
{
    ...
    self.students = [@[@"Joshua", @"Kyle", @"Christopher", @"Kai Luo", @"Sydney", @"Nathaniel", @"Joshua", @"Nathaniel", @"Jiaren", @"Thomas", @"Fang", @"Peter"] mutableCopy];}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"number = %d", indexPath.row];
